...
- `nextMonth`: 今日から約6週間の範囲で「カレンダー未登録」かつ嗜好傾向に近い公演を6〜10件（2026-09-16以前は約1ヶ月・4〜8件だったが、提案数を増やしたいという要望と、強い候補が窓をわずかに超えて見送りになる問題を受けて恒久的に広げた）。主力の情報源は（1）演劇人・公社流体力学のnote連載「公社が◯月に見たい演劇」、（2）芸術祭・フェスティバルの公式ラインアップ。**会場の頻出度は推薦理由にしない**（嗜好と直結しない）。選別は登録履歴から抽出したテイスト軸で行う。詳細は [docs/WEEKLY_TASK.md](docs/WEEKLY_TASK.md) ステップ4
